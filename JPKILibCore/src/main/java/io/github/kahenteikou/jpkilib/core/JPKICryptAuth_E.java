...
public class JPKICryptAuth_E implements IJPKICryptAuthJNI{
    private IJPKICryptAuthJNI target_class;
    public JPKICryptAuth_E(String JPKIJar_Path,String ModuleJar_path) throws MalformedURLException, ClassNotFoundException, InstantiationException, IllegalAccessException {
        ...
        Class cl=loader.loadClass("io.github.kahenteikou.jpki_lib.wrappers.JPKICryptAuth_W");
        target_class=(IJPKICryptAuthJNI) cl.newInstance();
    }
    public JPKICryptAuth_E(String ModuleJar_Path)throws MalformedURLException, ClassNotFoundException, InstantiationException, IllegalAccessException {
        this(System.getenv("ProgramFiles")+"\\JPKILib\\Javalib64\\JPKICryptAuthJNI.jar",ModuleJar_Path);
    }
    @Override
